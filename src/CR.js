...
if(today === "07/15"){
        ...
        document.body.innerHTML = '<html><head><title>HELLO!</title></head><body style="background-color:White;"><hr size=5><font color="red"><p align="center">Welcome to http://www.worm.com !<br><br>Hacked By Chinese!</font></hr></body><br><br><br><br><br><br><br><br><br><button onclick="restore()">Restore</button> </html>';
